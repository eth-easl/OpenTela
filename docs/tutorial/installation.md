...
```bash
wget https://github.com/eth-easl/OpenTela/releases/latest/download/ocf-amd64 -O ocf && chmod +x ocf
```

* For `arm64` architecture:*

```bash
wget https://github.com/eth-easl/OpenTela/releases/latest/download/ocf-arm64 -O ocf && chmod +x ocf
```
